...
export RUN_STAMP=${RUN_STAMP:-20260713_phase3_2_rescue_00186}
SEED=${SEED:-1}

export EXP_NAME=${EXP_NAME:-srsa_axial_online_family_taskctx_repair_01125_00256_00186_rescue}
export SOURCE_CHECKPOINT=${SOURCE_CHECKPOINT:-${REPO_ROOT}/logs/isaaclab-srsa-assembly/1/srsa_axial_online_family_taskctx_repair_01125_00256_00186/20260712_phase3_1_00186_stage-3_asm-00186/models/best_step-99840_s-0p1016.pt}
...
export CURRENT_RATIO=${CURRENT_RATIO:-0.75}
export ANCHOR_RATIO=${ANCHOR_RATIO:-0.125}
export HISTORY_RATIO=${HISTORY_RATIO:-0.125}
export MIN_CURRENT_EPISODES=${MIN_CURRENT_EPISODES:-5}
export ONLINE_FAMILY_SAMPLE_BALANCE=${ONLINE_FAMILY_SAMPLE_BALANCE:-ratio}

# Two exact 25,088-step intervals preserve one continuous current replay buffer.
export STEPS_PER_TASK=${STEPS_PER_TASK:-50176}
export NUM_ENVS=${NUM_ENVS:-256}
export RETENTION_NUM_ENVS=${RETENTION_NUM_ENVS:-256}
export EVAL_FREQ=${EVAL_FREQ:-25088}
export SAVE_FREQ=${SAVE_FREQ:-25088}
